  ...
  >
    ...
    <div class="modal-actions">
      <div class="modal-actions-left">
        ...
        <Button variant="secondary" :disabled="busy" @click="handleCustomizeOg">
          <LockIcon v-if="!isEarlyAccessEnrolled" :size="12" style="margin-right: 4px;" />
          OpenGraph Editor
        </Button>
      </div>
