<template>
  <div
    class="music-player"
    :class="[
      `tile-${effectiveTileSize}`,
      `platform-${content.platform}`,
      { 'tile-4x4--compact': compact4x4, 'music-player--intro': showIntro },
    ]"
    :style="{
      '--bg-base': bgBase,
      '--bg-tinted': bgTinted,
  ...
  >
    ...
    <div
      v-if="showIntro"
      class="music-intro"
      :class="{ 'music-intro--done': loadingDone }"
      :style="{ '--intro-brand': introBrandColor }"
    >
      <div
        class="music-intro-icon"
        :class="{ 'music-intro-icon--fly': loadingDone }"
      >
        <!-- Spotify -->
        <svg
          v-if="content.platform === 'spotify'"
          viewBox="0 0 24 24"
          fill="white"
          width="100%"
          height="100%"
        >
          <path
            d="M12.438 1.009C6.368.769 1.251 5.494 1.008 11.565c-.24 6.07 4.485 11.186 10.556 11.426 6.07.242 11.185-4.484 11.427-10.554S18.507 1.251 12.438 1.009m4.644 16.114a.657.657 0 0 1-.897.246 13.2 13.2 0 0 0-4.71-1.602 13.2 13.2 0 0 0-4.968.242.658.658 0 0 1-.31-1.278 14.5 14.5 0 0 1 5.46-.265c1.837.257 3.579.851 5.177 1.76.315.178.425.58.246.896zm1.445-2.887a.853.853 0 0 1-1.158.344 16.2 16.2 0 0 0-5.475-1.797 16.2 16.2 0 0 0-5.758.219.855.855 0 0 1-1.018-.65.85.85 0 0 1 .65-1.018 17.9 17.9 0 0 1 6.362-.241 17.9 17.9 0 0 1 6.049 1.985c.415.224.57.743.344 1.158zm1.602-3.255a1.05 1.05 0 0 1-1.418.448 19.7 19.7 0 0 0-6.341-2.025 19.6 19.6 0 0 0-6.655.199 1.05 1.05 0 1 1-.417-2.06 21.7 21.7 0 0 1 7.364-.22 21.7 21.7 0 0 1 7.019 2.24c.515.268.715.903.448 1.418"
          />
        </svg>
        <!-- Apple Music Icon (full branded icon for intro) -->
        <svg
          v-else
          width="100%"
          height="100%"
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M72 22.52C72 21.66 72 20.8 72 19.94C72 19.22 71.99 18.49 71.97 17.77C71.93 16.19 71.83 14.6 71.55 13.04C71.27 11.46 70.8 9.98 70.07 8.54C69.35 7.13 68.41 5.83 67.29 4.71C66.17 3.59 64.87 2.65 63.46 1.93C62.02 1.2 60.55 0.73 58.97 0.45C57.41 0.17 55.82 0.08 54.24 0.03C53.51 0.02 52.78 0.01 52.06 0C51.2 0 50.34 0 49.48 0H22.52C21.66 0 20.8 0 19.94 0C19.22 0 18.49 0.01 17.77 0.03C16.19 0.07 14.6 0.17 13.04 0.45C11.46 0.74 9.98 1.2 8.55 1.94C7.13 2.66 5.84 3.6 4.72 4.72C3.6 5.84 2.65 7.13 1.93 8.55C1.2 9.99 0.73 11.46 0.45 13.05C0.17 14.61 0.08 16.2 0.03 17.78C0.02 18.5 0.01 19.22 0 19.94C0 20.8 0 21.66 0 22.52V49.47C0 50.33 0 51.19 0 52.05C0 52.77 0.01 53.5 0.03 54.22C0.07 55.8 0.17 57.39 0.45 58.95C0.73 60.53 1.2 62.01 1.93 63.45C2.65 64.86 3.59 66.16 4.71 67.28C5.83 68.4 7.13 69.34 8.54 70.06C9.98 70.79 11.45 71.26 13.03 71.54C14.59 71.82 16.18 71.91 17.76 71.96C18.48 71.98 19.21 71.99 19.93 71.99C20.79 72 21.65 71.99 22.51 71.99H49.46C50.32 71.99 51.18 71.99 52.04 71.99C52.76 71.99 53.49 71.98 54.21 71.96C55.79 71.92 57.38 71.82 58.94 71.54C60.52 71.26 62 70.79 63.43 70.06C64.84 69.34 66.14 68.4 67.26 67.28C68.38 66.16 69.32 64.87 70.04 63.45C70.77 62.01 71.24 60.54 71.52 58.95C71.8 57.39 71.89 55.8 71.94 54.22C71.96 53.5 71.97 52.77 71.97 52.05C71.98 51.19 71.97 50.33 71.97 49.47L72 22.52Z"
            fill="url(#am-intro-grad)"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M50.9 11C50.73 11.02 49.18 11.29 48.99 11.33L27.59 15.65H27.58C27.02 15.77 26.58 15.97 26.25 16.25C25.84 16.59 25.62 17.08 25.53 17.64C25.51 17.76 25.48 18 25.48 18.36C25.48 18.36 25.48 40.22 25.48 45.14C25.48 45.77 25.43 46.37 25.01 46.89C24.59 47.41 24.06 47.56 23.45 47.69C22.98 47.78 22.52 47.88 22.05 47.97C20.28 48.33 19.13 48.57 18.09 48.97C17.09 49.36 16.35 49.85 15.75 50.47C14.57 51.7 14.09 53.38 14.26 54.95C14.4 56.29 15 57.57 16.04 58.51C16.74 59.15 17.61 59.64 18.64 59.84C19.71 60.05 20.84 59.98 22.5 59.64C23.38 59.46 24.21 59.18 25 58.72C25.78 58.26 26.45 57.65 26.97 56.9C27.49 56.15 27.83 55.32 28.02 54.43C28.21 53.52 28.26 52.69 28.26 51.78V28.56C28.26 27.32 28.61 26.99 29.62 26.74C29.62 26.74 47.41 23.15 48.24 22.99C49.4 22.77 49.94 23.1 49.94 24.31V40.17C49.94 40.8 49.93 41.43 49.51 41.95C49.09 42.47 48.56 42.62 47.95 42.75C47.48 42.84 47.02 42.94 46.55 43.03C44.78 43.39 43.63 43.63 42.59 44.03C41.59 44.42 40.85 44.91 40.25 45.53C39.07 46.76 38.55 48.44 38.72 50.01C38.86 51.35 39.5 52.63 40.54 53.57C41.24 54.21 42.11 54.68 43.14 54.89C44.21 55.1 45.34 55.03 47 54.69C47.88 54.51 48.71 54.25 49.5 53.78C50.28 53.32 50.95 52.71 51.47 51.96C51.99 51.21 52.33 50.38 52.52 49.49C52.71 48.58 52.72 47.75 52.72 46.84V12.89C52.71 11.66 52.06 10.9 50.9 11Z"
            fill="white"
          />
          <defs>
            <linearGradient
    ...
    <template v-if="!hasError && effectiveTileSize === '1x1'">
      <div class="header-row">
        <a
          v-show="!showIntro"
          :href="content.trackUrl"
          target="_blank"
          rel="noopener"
          class="platform-logo platform-logo--fill"
          :title="platformTitle"
        >
          <!-- Spotify logo -->
          <svg
    ...
    <template v-else-if="!hasError && effectiveTileSize === '2x2'">
      <div class="header-row header-row--2x2">
        ...
        <div class="header-content header-content--2x2">
          <div class="record-inline">
            <img
              class="record-img"
              src="/assets/music/vinylRecord.png"
              alt="vinyl record"
            />
            <img
              class="record-label"
            ...
            />
            <img
              class="record-shimmer"
              :class="vinylPhase"
              src="/assets/music/vinylHighlightShimmer.png"
              alt=""
            />
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            class="platform-logo platform-logo--corner"
            :title="platformTitle"
          >
            <svg
              v-if="content.platform === 'spotify'"
      ...
      <div class="controls-bar controls-bar--2x2">
        <button
          ...
          @click="togglePlay"
        >
          <MusicPlayIcon v-if="!isPlaying" :size="16" />
          <MusicPauseIcon v-else :size="16" />
        </button>
        <div
          class="volume-ctl-2x2"
        ...
        >
          ...
          <button
            ...
            @click="toggleMute"
          >
            <MusicVolumeMuteIcon v-if="volumeIcon === 'mute'" />
            <MusicVolumeLowIcon v-else-if="volumeIcon === 'low'" />
            <MusicVolumeMidIcon v-else-if="volumeIcon === 'mid'" />
            <MusicVolumeHighIcon v-else />
          </button>
        </div>
      </div>
    </template>
    ...
    <template v-else-if="!hasError && effectiveTileSize === '2xN'">
      <div class="header-row header-row--2x2">
        ...
        <div v-if="show2xNExtras" class="song-info-2xN">
          <h1 class="track-name">
            <a :href="content.trackUrl" target="_blank" rel="noopener">{{
              content.trackName
            }}</a>
          </h1>
          <p class="artist-name">
            <a :href="content.artistUrl" target="_blank" rel="noopener">{{
              content.artistName
            }}</a>
          </p>
        </div>
        ...
        <div class="header-content">
          <div class="vinyl-overlay">
            ...
            <div
              ...
              :style="{
                opacity:
                  vinylPhase === 'toss-cover' ||
                  vinylPhase === 'slide-back' ||
                  vinylPhase === 'spinning' ||
                  vinylPhase === 'spinning-paused'
                    ? 0
                    : 1,
        ...
        >
          ...
          <div class="slider-tag-slot">
            <div
              ...
              :class="{ 'vol-slider-wrap--expanded': showVolume }"
              @mouseenter="onVolumeEnter"
              @mouseleave="onVolumeLeave"
            >
              <input
...
import MusicVolumeLowIcon from "../icons/media/MusicVolumeLowIcon.vue";
import MusicVolumeMidIcon from "../icons/media/MusicVolumeMidIcon.vue";
import MusicVolumeHighIcon from "../icons/media/MusicVolumeHighIcon.vue";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const bgBase = computed(() =>
      props.content.platform === "apple"
        ? "#FFFFFF"
        : props.content.backgroundColor || "rgba(30, 30, 30, 1)",
    );
    const bgTinted = computed(() =>
      props.content.platform === "apple"
        ? "#D7D7D7"
        : props.content.backgroundTinted || "rgba(50, 50, 50, 1)",
    );
    const txtSubdued = computed(() =>
      props.content.platform === "apple"
        ? "rgba(0,0,0,0.85)"
        : props.content.textSubdued || "rgba(180, 180, 180, 1)",
    );
    const platformTitle = computed(() =>
      props.content.platform === "spotify"
        ? "Play on Spotify"
        : "Play on Apple Music",
    );
    ...
    const armRotation = computed(() => {
      if (!isPlaying.value && vinylPhase.value !== "spinning-paused")
        return ARM_REST_DEG;
    ...
    function getNoteCanvasDims() {
      ...
      return {
        cx: canvas.width / 2,
        cy: canvas.height / 2,
        r: Math.min(canvas.width, canvas.height) * 0.225,
      };
    }
    ...
    function pauseVinyl() {
      vinylPhase.value = "spinning-paused";
    }
    function resumeVinyl() {
      vinylPhase.value = "spinning";
      startNotes();
    }

    function _resetVinyl() {
    ...
    function getLogBars(dataArray: Uint8Array) {
      ...
      for (let i = 0; i < NUM_BARS; i++) {
        ...
        const freqHigh =
          MIN_FREQ * Math.pow(MAX_FREQ / MIN_FREQ, (i + 1) / NUM_BARS);
        const binLow = Math.max(0, Math.floor(freqLow / binHz));
        const binHigh = Math.min(
          dataArray.length - 1,
          Math.floor(freqHigh / binHz),
        );
        let peak = 0;
    ...
    function getSubduedRgb() {
      ...
      const raw = getComputedStyle(canvasEl.value)
    ...
    function drawIdle() {
      ...
      for (let i = 0; i < NUM_BARS; i++) {
        ...
        const v =
          ...
          0.3 * Math.abs(Math.sin(t * Math.PI * 9 + 1.2)) +
...
.music-intro-icon {
  ...
  animation:
    music-icon-grow 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) both,
...
.volume-slider--vertical {
  ...
  background: linear-gradient(
    to top,
    white var(--fill, 100%),
    rgba(255, 255, 255, 0.21) var(--fill, 100%)
  );
  border-radius: 4px;
}
...
@keyframes toss-cover {
  ...
  100% {
    transform: translate(-30px, -360px) rotate(-0.1turn);
    opacity: 0;
  }
}
...
.record-wrap.slide-out {
  animation: record-slide-out 0.65s cubic-bezier(0.25, 0.46, 0.45, 0.94)
    forwards;
}
...
.record-wrap.toss-cover {
  transform: translateX(100%);
}

.record-wrap.slide-back {
  animation: record-slide-back 0.55s cubic-bezier(0.25, 0.46, 0.45, 0.94)
    forwards;
}
...
.record-label.spinning {
  animation: label-spin 2.4s linear infinite;
}
.record-label.spinning-paused {
  animation: label-spin 2.4s linear infinite paused;
}
...
.record-shimmer.spinning {
  animation: shimmer-rock 1.6s ease-in-out infinite;
}
.record-shimmer.spinning-paused {
  animation: shimmer-rock 1.6s ease-in-out infinite paused;
}
...
.platform-apple .track-name a {
  color: black;
}
.platform-apple .artist-name {
  color: black;
}
.platform-apple .artist-name a {
  color: black;
}
.platform-apple .track-bar {
...
.platform-apple .play-btn:hover {
  color: #000000;
}
.platform-apple .play-btn--small:hover {
  color: #000000;
}
.platform-apple .icon-btn:hover {
  color: #000000;
}
.platform-apple .retry-btn:hover {
...
.platform-apple .volume-slider {
  background: linear-gradient(
    to right,
    rgba(0, 0, 0, 0.85) var(--fill, 100%),
    rgba(0, 0, 0, 0.21) var(--fill, 100%)
  );
}
.platform-apple .volume-slider::-webkit-slider-thumb {
  background: rgba(0, 0, 0, 0.85);
}
.platform-apple .volume-slider::-moz-range-thumb {
  background: rgba(0, 0, 0, 0.85);
}
...
.platform-apple .volume-slider--vertical::-webkit-slider-thumb {
  background: rgba(0, 0, 0, 0.85);
}
</style>
