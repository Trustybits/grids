<template>
  ...
  >
    ...
    >
      ...
      >
        <!-- Spotify -->
        <SpotifyLogoIcon v-if="content.platform === 'spotify'" size="100%" />
      ...
      <div class="header-row header-row--2x2">
        ...
        <div class="header-content header-content--2x2">
          ...
          <a
            ...
            :title="platformTitle"
          >
            <SpotifyLogoIcon v-if="content.platform === 'spotify'" />
            <svg
              v-else
              viewBox="0 0 73 73"
              fill="none"
...
import SpotifyLogoIcon from "../icons/SpotifyLogoIcon.vue";
