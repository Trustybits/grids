  ...
  >
    ...
    >
      ...
      <div class="center-controls" v-if="!isEditing">
        ...
        >
          <ReplayIcon v-if="videoEnded" />
          <PlayFilledIcon v-else-if="!isPlaying && playbackMode === 'playing'" />
          <PauseFilledIcon v-else />
        </button>
      </div>
        ...
        <div class="controls-row">
          ...
          >
            <button class="control-btn mute-btn" @click.stop="toggleMute">
              <VolumeMuteFilledIcon v-if="isMuted || volume === 0" />
              <VolumeLowFilledIcon v-else-if="volume < 0.1" />
              <VolumeHighFilledIcon v-else />
            </button>
...
import VolumeMuteFilledIcon from "../icons/media/VolumeMuteFilledIcon.vue";
import VolumeLowFilledIcon from "../icons/media/VolumeLowFilledIcon.vue";
import VolumeHighFilledIcon from "../icons/media/VolumeHighFilledIcon.vue";
import FullscreenIcon from "../icons/media/FullscreenIcon.vue";
import FullscreenExitIcon from "../icons/media/FullscreenExitIcon.vue";
