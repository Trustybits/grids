...
export default defineComponent({
  ...
  setup(props) {
    ...
    // Which color the swatches/hex field currently edit. Only meaningful when
    // the tile supports a separate overlay; otherwise it stays on "fill".
    const target = ref<"fill" | "overlay">("fill");
