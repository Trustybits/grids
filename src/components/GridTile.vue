...
export default defineComponent({
  ...
  setup(props) {
    ...
    const showCaption = computed(() => {
      // Hide caption for Link, Text, Embed, RPG, and Suggestion tiles as requested
      const hiddenTypes = [ContentType.LINK, ContentType.TEXT, ContentType.EMBED, ContentType.RPG, ContentType.SUGGESTION];
