  ...
  <div class="home-landing">
    ...
    <header class="home-landing__topbar">
      ...
      <div class="home-landing__topbar-actions home-landing__topbar-reveal">
        ...
        <router-link class="home-landing__btn home-landing__btn--ghost liquid-metal-outline liquid-metal-outline--chrome" to="/login">Log in</router-link>
      </div>
    </header>
    ...
    <main class="home-landing__content">
      <section class="home-landing__hero">
        <div class="home-landing__hero-copy">
          ...
          <div class="home-landing__hero-actions">
            ...
            <router-link class="home-landing__btn home-landing__btn--soft liquid-metal-outline liquid-metal-outline--mercury" to="/pricing">See plans</router-link>
          </div>
      ...
      <section class="home-landing__section home-landing__section--cta">
        ...
        <div class="liquid-metal-demo-blocks" aria-hidden="true">
          <div class="liquid-metal-preview liquid-metal-outline liquid-metal-outline--chrome"></div>
          <div class="liquid-metal-preview liquid-metal-fill liquid-metal-fill--mercury"></div>
        </div>
