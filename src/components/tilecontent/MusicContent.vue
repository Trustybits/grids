    ...
    <template v-else-if="!hasError && effectiveTileSize === '2x2'">
      ...
      <div class="controls-bar controls-bar--2x2">
        ...
        >
          <svg
            v-if="!isPlaying"
            viewBox="0 0 19 18.13"
            width="16"
            height="16"
            fill="currentColor"
          >
            <path
              d="M17.4086 6.66543C19.5305 7.71151 19.5305 10.4194 17.4086 11.4654L4.59662 17.7814C2.53435 18.7981 0 17.4748 0 15.3814V2.74945C0 0.656047 2.53435 -0.667198 4.59661 0.349454L17.4086 6.66543Z"
            />
          </svg>
          <svg
            v-else
          ...
          >
            ...
            >
              ...
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M18.6604 8.41592C19.008 8.21868 19.4464 8.3466 19.6395 8.70163L19.0101 9.05877C19.6395 8.70163 19.6395 8.70163 19.6395 8.70163L19.6402 8.70292L19.6409 8.70429L19.6425 8.70727L19.6462 8.71425L19.6555 8.73224C19.6624 8.74604 19.671 8.76345 19.6808 8.78454C19.7005 8.82673 19.7254 8.8836 19.7536 8.95571C19.8101 9.10001 19.8798 9.30487 19.9475 9.57473C20.0832 10.115 20.2101 10.9119 20.2101 12.0003C20.2101 13.0888 20.0832 13.8857 19.9475 14.4259C19.8798 14.6958 19.8101 14.9007 19.7536 15.045C19.7254 15.1171 19.7005 15.1739 19.6808 15.2161C19.671 15.2372 19.6624 15.2546 19.6555 15.2684L19.6462 15.2864L19.6425 15.2934L19.6409 15.2964L19.6402 15.2978C19.6402 15.2978 19.6395 15.299 19.0101 14.9419L19.6395 15.299C19.4464 15.6541 19.008 15.782 18.6604 15.5847C18.3158 15.3892 18.1898 14.9474 18.3759 14.5938L18.3807 14.5838C18.3873 14.5697 18.3999 14.5415 18.4166 14.4987C18.4501 14.4132 18.5004 14.2688 18.5527 14.0606C18.6571 13.6448 18.7701 12.9709 18.7701 12.0003C18.7701 11.0298 18.6571 10.3559 18.5527 9.94004C18.5004 9.7319 18.4501 9.58745 18.4166 9.50194C18.3999 9.45915 18.3873 9.43099 18.3807 9.41688L18.3759 9.40684C18.1898 9.05329 18.3158 8.61149 18.6604 8.41592Z"
              />
            </svg>
            <svg
              v-else
            ...
            >
              ...
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M20.4581 5.5523C20.7507 5.29229 21.1856 5.33445 21.4294 5.64646L20.8996 6.11724C21.4294 5.64646 21.4292 5.64613 21.4294 5.64646L21.4305 5.64781L21.4317 5.64932L21.4344 5.65286L21.4413 5.66195C21.4465 5.66891 21.453 5.67767 21.4607 5.68825C21.4761 5.7094 21.4961 5.73783 21.5201 5.77369C21.5681 5.8454 21.6321 5.94678 21.7065 6.079C21.8554 6.34356 22.0456 6.73103 22.233 7.25049C22.6083 8.29118 22.9686 9.85147 22.9686 12.0003C22.9686 14.1492 22.6083 15.7095 22.233 16.7502C22.0456 17.2696 21.8554 17.6571 21.7065 17.9217C21.6321 18.0539 21.5681 18.1553 21.5201 18.227C21.4961 18.2628 21.4761 18.2913 21.4607 18.3124C21.453 18.323 21.4465 18.3318 21.4413 18.3387L21.4344 18.3478L21.4317 18.3514L21.4305 18.3529C21.4302 18.3532 21.4294 18.3542 20.8996 17.8834L21.4294 18.3542C21.1856 18.6662 20.7507 18.7084 20.4581 18.4484C20.1669 18.1896 20.1264 17.7291 20.3663 17.4171C20.3669 17.4164 20.368 17.4149 20.3695 17.4128C20.3744 17.4061 20.384 17.3926 20.3977 17.3721C20.4251 17.3312 20.4689 17.2626 20.5238 17.165C20.6335 16.9699 20.7881 16.6588 20.9456 16.2222C21.2599 15.3509 21.5893 13.9696 21.5893 12.0003C21.5893 10.031 21.2599 8.64979 20.9456 7.77847C20.7881 7.34192 20.6335 7.03077 20.5238 6.83571C20.4689 6.73813 20.4251 6.66945 20.3977 6.62856C20.384 6.60811 20.3744 6.5946 20.3695 6.58789C20.368 6.58572 20.3669 6.58427 20.3663 6.58351"
              />
            </svg>
          </button>
        </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const fetchMetadata = async () => {
      ...
      try {
        const getMusicTrackMetadata = httpsCallable(
          functions,
